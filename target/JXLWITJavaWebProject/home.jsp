...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="thumbnail">
                <img src="images/business.png" width="150" height="150" alt="...">
                <div class="caption">
                    <h3>专注业务</h3>
        ...
        <div class="col-md-6">
            <div class="thumbnail">
                <img src="images/code.png" width="150" height="150" alt="...">
                <div class="caption">
                    <h3>代码复用</h3>
                    <h5>Code Reuse</h5>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="thumbnail">
                <img src="images/power.png" width="150" height="150" alt="...">
                <div class="caption">
                    <h3>权限管理</h3>
        ...
        <div class="col-md-6">
            <div class="thumbnail">
                <img src="images/security.png" width="150" height="150" alt="...">
                <div class="caption">
                    <h3>安全管理</h3>
