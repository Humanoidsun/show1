...
<head>
    ...
    <%--<script src="<%= basePath %>/plugins/echarts/shine.js"></script>--%>
    ...
    <script src="<%= basePath %>/script/common/mybootstrap.js"></script>
    <script src="<%= basePath %>/script/common/bootstrapvalidators.js"></script>
    <script src="<%= basePath %>/script/common/clientStorage.js"></script>
    <script src="<%= basePath %>/script/business/myproject.js"></script>
    <script>
        var kbValidator=new MyBootstrapValidator();
        $(function(){
            toastr.options = {
