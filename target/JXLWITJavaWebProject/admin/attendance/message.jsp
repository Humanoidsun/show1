                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-left">
                                <li><a>当前目录</a></li>
                                <li class="active"><a href="message.jsp"> 消息管理</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5 col-lg-offset-1">
                                            <div class="input-group input-group-default">
                                                <input type="text" id="text"  name="text" class="form-control" placeholder="请输入消息内容进行查找">
                                                <span class="input-group-btn"><button class="btn btn-primary" type="button" onclick="show()"><i class="ti-search"></i></button></span>
                                            </div>
                                        </div>
                                        <%--<div class="col-lg-6">--%>
                                            <%--<div class="input-group input-group-default">--%>
                                                <%--<span class="input-group-btn"><button  data-toggle="modal" data-target="#addDialog" class="btn btn-primary" type="button" >新增</button></span>--%>
                                            <%--</div>--%>
                                        <%--</div>--%>
                                        <%--</div>--%>
                                </form>
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="edit_form">
                    <div class="form-group">
                        <div class="col-sm-4">
                            <input type="hidden" class="form-control" id="edit_id" placeholder="ID" name="id">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="edit_type" placeholder="消息类型" name="type" disabled="disabled">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="edit_datetime" class="col-sm-3 control-label">
                            产生日期
                        </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="edit_datetime" placeholder="产生日期" name="datetime" disabled="disabled">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="edit_text" class="col-sm-3 control-label">
                            内容
                        </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="edit_text" placeholder="内容" name="text">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="edit_acceptname" class="col-sm-3 control-label">
                            收件人
                        </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="edit_acceptname" placeholder="收件人ID" name="acceptname" disabled>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="edit_sendname" class="col-sm-3 control-label">
                            发件人
                        </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="edit_sendname" placeholder="收件人ID" name="sendname" disabled>
                        </div>
                    </div>
    ...
    <div class="modal-dialog" role="document" style="width: 600px;height: 500px">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabe2">新增消息</h4>
            </div>

            <div class="modal-body">
                <form class="form-horizontal" id="add_from">
                    <div class="form-group">
                        <label for="add_id" class="col-sm-3 control-label">
                            消息编号
                        </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="add_id" placeholder="消息编号" name="id">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="add_datetime" class="col-sm-3 control-label">
                            产生日期
                        </label>
                        <div class="col-sm-8">
                            <input type="date" class="form-control" id="add_datetime" placeholder="产生日期" name="datetime">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="add_type" placeholder="消息类型" name="type">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="add_text" placeholder="内容" name="text">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="add_acceptid" class="col-sm-3 control-label">
                            收件人ID
                        </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="add_acceptid" placeholder="收件人ID" name="acceptid">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="add_sendid" class="col-sm-3 control-label">
                            发件人ID
                        </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="add_sendid" placeholder="收件人ID" name="sendid">
                        </div>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    function show(){
        var con=getFormData($("#messagefind"));
        $.ajax({
            type: 'post',
                ...
                if (result.obj != undefined && result.obj != null) {
                    ...
                    for (var i = 0; i < result.obj.length; i++) {
                        ...
                        s += "<td>" + (i + 1) + "</td>" +
                            ...
                            "<td>" + result.obj[i].text+"</td>"  +
                            "<td>" + result.obj[i].acceptname+"</td>"  +
                            "<td>" + result.obj[i].sendname+"</td>"  +
                            "<td><button class='btn btn-danger btn-rounded m-b-10 m-l-5' type='button' onclick='deletecrmstaff(\"" + id + "\")'>删除</button>" +
                            "<button class='btn btn-warning btn-rounded m-b-10 m-l-5' data-toggle='modal' data-target='#crmstaffEditDialog' onclick='editcrmstaff(\"" + id +
                            "\")'><a>修改</a></button></td>";
                        s += "</tr>";
                    }
                }
    ...
    function editcrmstaff(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#edit_datetime").val(formatDateTimebox(data.obj.datetime));
                $("#edit_type").val(data.obj.type);
                $("#edit_text").val(data.obj.text);
                $("#edit_acceptname").val(data.obj.acceptname);
                $("#edit_sendname").val(data.obj.sendname);

            }
        });
    }
    function updatecrmstaff() {
        doData("/Message/updatebyid",getFormData($("#edit_form")), function(data){
                alert(result.message);
            });
    }
</script>
