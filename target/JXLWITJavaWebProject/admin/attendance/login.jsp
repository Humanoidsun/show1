        ...
        <div class= "tm-content col-md-4 col-sm-8 col-xs-8 col-md-offset-4" style="padding-top: 180px;padding-bottom: 50px;">
            ...
            <form action="#" method="get" class="subscribe-form">
                ...
                <div class="row form-section">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-7">
                        <input name="password" type="text" class="form-control" id="password" placeholder="请输入密码" required/>
                    </div>
                </div>

                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-6 col-md-offset-3">
                        <button type="submit" class="tm-btn-subscribe" onclick="login()">登录</button>
                    </div>
                    <div class="col-md-5 col-sm-6 col-xs-6">
                        <button type="submit" class="tm-btn-subscribe" onclick="">注册</button>
                    </div>
                </div>
            </form>
