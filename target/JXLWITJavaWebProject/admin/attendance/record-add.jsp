                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-left">
                                    <li><a>当前目录</a></li>
                                    <li class="active"><a href="record-add.jsp"> 打卡</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="todo-list">
                                    <form class="form-horizontal">
                                        <div class="form-group">
                                            <label for="face" class="col-sm-2 control-label">请拍照</label>
                                            <div class="col-sm-8">
                                                <input class="form-control" id="face" name="face" type="file" accept="image/" capture="camera">
                                            </div>
                                            <div class="col-sm-2">
                                                <button type="button" class="btn btn-primary btn-rounded m-b-10 m-l-5" data-toggle="modal" data-target="#editprofile" onclick="checkin()">确认</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
<script type="text/javascript">
    function checkin() {
        doData("/Record/save",new Object(),function (result) {
    ...
    function startTime(){
        ...
        h=checkTime(h);
        qi=getXingQi(qi);
        document.getElementById('txt').innerHTML=year+"年"+mo+"月"+ri+"日 星期"+qi+" "+h+":"+m+":"+s;
        t=setTimeout(function(){startTime()},500);
    }
    function getXingQi(x) {
        switch (x) {
            case 1:
                return "一";break;
            case 2:
