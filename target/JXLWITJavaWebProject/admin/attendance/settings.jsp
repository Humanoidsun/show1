                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-left">
                                <li><a>当前目录</a></li>
                                <li class="active"><a href="staff.jsp"> 系统信息设置</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card alert">
                            ...
                            <div id="card-body">
                                <form class="form-inline" id="setting">
                                    <div class="form-group col-sm-offset-1">
                                        <label for="advanceminute" >提前几分钟提示打卡</label>
                                        <div class="input-group input-group-default" >
                                            <input type="number" id="advanceminute" name="advanceminute" class="form-control" min="1" max="30" style="height: 20px;">
                                        </div>
                                    </div>
                                    <button type="button" onclick="update()" class="btn btn-primary btn-flat btn-addon m-b-10 m-l-5"><i class="ti-settings" style="height: 30px"></i>保存</button>
                                 </form>
                            </div>
                        </div><!-- /# card -->
                    </div><!-- /# column -->
...
<script type="text/javascript">
    window.onload=function () {
        $.ajax({
            ...
            success: function (result) {
                if (result.code == "0002") {
                    $("#advanceminute").val(result.obj.advanceminute);
                }
                else {
    ...
    function update() {
        doData("/Setting/update",getFormData($("#setting")),function (result) {
            alert(result.message);
