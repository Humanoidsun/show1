                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-left">
                                    <li><a>当前目录</a></li>
                                    <li class="active"><a href="calendar.jsp"> 考勤信息查询</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-offset-1">
                                                ...
                                                <div class="input-group input-group-default">
                                                    ...
                                                    <span class="input-group-btn"><button class="btn btn-primary" type="button" onclick="find()"><i class="ti-search"></i></button></span>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
...
<script type="text/javascript">
    function find() {
        doData("/Record/findByTime",getFormData($("#recordfind")),function (result) {

            if(result.obj!=null&&result.obj!=undefined){
                var str = "";
                for(var i = 0; i < result.obj.length; i++){
                    str += "<tr><td>"+(i+1)+"</td>";
                    str += "<td>"+formatDateTimebox(result.obj[i].datetime)+"</td>";
                    str += "<td>"+result.obj[i].type+"</td>";
                    str += "<td>"+result.obj[i].status+"</td></tr>";
                }
                $("#list").html(str);
            }
        },true);
